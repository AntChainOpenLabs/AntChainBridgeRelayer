...
(
    ...
    `amclient_contract_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `version`                   int(11)                                                       DEFAULT NULL,
...
(
    ...
    `sender_amclient_contract`    varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    ...
    `receiver_amclient_contract`  varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    ...
    `tx_fail_reason`              varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `gmt_create`                  datetime                                                      DEFAULT CURRENT_TIMESTAMP,
    `gmt_modified`                datetime                                                      DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
...
(
    ...
    `blockchain_product` varchar(64) BINARY                                            DEFAULT NULL,
    `blockchain_id`      varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `ext`                varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
    `timeslice`          datetime(3)                                                   DEFAULT CURRENT_TIMESTAMP,
    `gmt_create`         datetime                                                      DEFAULT CURRENT_TIMESTAMP,
    `gmt_modified`       datetime                                                      DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
...
(
    ...
    `last_active_time` datetime(3)                                                  DEFAULT CURRENT_TIMESTAMP,
    `gmt_create`       datetime                                                     DEFAULT CURRENT_TIMESTAMP,
    `gmt_modified`     datetime                                                     DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
